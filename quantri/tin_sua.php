<style>
    ...
    .form-group .form-control {padding:3px; border:1px solid #a7a3a380;    border-radius: 4px;}
            ...
            <div class="body">
                <form id="form_validation" method="POST">
                    ...
                    <div class="row cleafix">
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-float">
                                <input type="radio" name="TinNoiBat" id="TNB1" value="1" <?=($row['TinNoiBat']==0)?"checked":""?> >
                                <label for="TNB0">Tin thường</label>
                                <input type="radio" name="TinNoiBat" id="TNB0" value="0" <?=($row['TinNoiBat']==1)?"checked":""?> >
                    ...
                    <div class="row cleafix">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"> <div class="form-line">
                                ...
                                <select class="btn btn-success" name="idTL" id="idTL">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"> <div class="form-line">
                                ...
                                <select class="btn btn-success" name="idLT" id="idLT">
